                ...
                <article className={`rounded-2xl border p-5 shadow-sm ${detailCardClass}`}>
                    ...
                    <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-slate-300/30 pt-4">
                        <button
                            ...
                            className={`inline-flex items-center gap-1 rounded-md border px-4 py-1.5 text-sm font-semibold transition hover:-translate-y-0.5 ${isSelectedBlogLiked ? (isDark ? 'border-orange-400 bg-orange-100 text-orange-700' : 'border-orange-300 bg-orange-50 text-orange-700') : (isDark ? 'border-slate-600 bg-slate-800 text-slate-100 hover:border-orange-400' : 'border-slate-300 bg-white text-slate-700 hover:border-orange-300 hover:bg-slate-50')}`}
                        >
